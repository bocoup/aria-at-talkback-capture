...
find_adb() {
  ...
  for location in "/home/$CURRENT_USER/Android/Sdk/platform-tools/adb" \
    "/opt/android-sdk/platform-tools/adb" \
    "/usr/local/bin/adb" \
    "/usr/bin/adb" \
    "/snap/bin/adb" \
    "/tmp/platform-tools-temp/platform-tools/adb"; do
  ...
  echo "/home/$CURRENT_USER/Android/Sdk/platform-tools/adb"
  echo "/opt/android-sdk/platform-tools/adb"
  echo "/usr/local/bin/adb"
  echo "/usr/bin/adb"
  echo "/snap/bin/adb"
  echo "/tmp/platform-tools-temp/platform-tools/adb"
  return 1
}
